...
ods_tag <- function(con, path){
  ...
  if (length(ft_to_tag$doi) < 1) {
    ...
    message("Over 500 papers to tag by open data / code statement. Selecting a sample of 500")
  ...
  message(paste0("Sucessfully written ", length(names(PDF_text_sentences)), 
                 " tagged citations to db"))
}
